...
class Contact extends Component {
  ...
  handleSubmit(values) {
      ...
      this.props.postFeedback(this.props.firstname, this.props.lastname, this.props.telnum, this.props.email, this.props.agree, this.props.contactType, this.props.message);
                            ...
                            <Col md={10}>
                                ...
                                <Errors
                                  ...
                                  messages={{
                                    ...
                                    maxLength: 'Must be less than 10 length'
                                  }}
                                />
                            </Col>
                        </Row>
